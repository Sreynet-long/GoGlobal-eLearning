...
query GetCourseEnrolledWithPagination($page: Int, $limit: Int, $keyword: String, $pagination: Boolean) {
  getCourseEnrolledWithPagination(page: $page, limit: $limit, keyword: $keyword, pagination: $pagination) {
    data {
      course_id
      title
      thumbnail
