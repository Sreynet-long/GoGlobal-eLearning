...
query GetCoverSliderPagination($page: Int, $limit: Int, $keyword: String, $pagination: Boolean, $isPublic: Boolean) {
  getCoverSliderPagination(page: $page, limit: $limit, keyword: $keyword, pagination: $pagination, is_public: $isPublic) {
    data {
      _id
      order
      image
