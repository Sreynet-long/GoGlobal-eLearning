...
export default function ChangePasswordScreen() {
  ...
  const [mobileUpdatePassword, { loading }] = useMutation(
    MOBILE_UPDATE_NEW_PASSWORD,
    {
      onCompleted: ({ mobileUpdatePassword }) => {
        ...
        Alert.alert(
          status ? t("success", language) : t("error", language),
          backendMessage ||
            (status
  ...
  const handleSubmit = () => {
    ...
    if (newPassword !== confirmPassword) {
      return Alert.alert(
        t("error", language),
        t("passwords_do_not_match", language)
      );
    }
    ...
    <View style={styles.screenContainer}>
      ...
      >
        <View style={styles.heroSection}>
          ...
          <Text style={styles.heroTitle}>{t("change_password", language)}</Text>
          <Text style={styles.heroSubtitle}>
            {t("Update_your_credentials_to_keep_your_account_secure", language)}
          </Text>
        </View>
