export default {
  ...
  well_provide_u_with_the_best_service_possible:
    "We will provide you with the best service possible. Open 24/7.",
  ...
  acceptance_of_terms_content: "Acceptance of terms content",
  user_accounts: "User Account",
  user_accounts_content: "User accounts content",
  intellectual_property: "Intellectual Property",
  intellectual_property_content: "Intellectual property content",
  privacy_policy: "Privacy Policy",
  privacy_policy_content: "Privacy policy content",
  limitation_of_liability: "Limitation Of Liability",
  limitation_of_liability_content: "Limitation of liability cotent",
  modifications: "Modifications",
  modifications_content: "Modifications content",
  terms_conditions: "Terms Conditions",
  terms_intro_text: "Terms Intro Text",
  contact_support: "Contact Support",
  well_provide_u_with_the_best_service_possible:
    "We'll provide u with the best service possible",
  unlock_your_potential_today:"Unlock your potential today",
  // open_the_door_to_new_knowledge_and_unlock_your_potential_today:
  //   "Open the door to new knowledge and unlock your potential today!",
  ...
  projects_practices:"projects practices",
  ...
  many_courses: "Many courses",
  skills_built: "Skills Built",
  access_free_courses_and_start_learning_today:"Access free courses and start learning today!",
};
